...
public class HelpUtils {
    ...
    public static class AboutDialog extends DialogFragment {
        ...
        public Dialog onCreateDialog(Bundle savedInstanceState) {
            ...
            aboutBodyView.setText(Html.fromHtml(getString(R.string.about_extension_text)));
            aboutBodyView.append("\n");
            aboutBodyView.append(Html.fromHtml(getString(R.string.about_license_text)));
